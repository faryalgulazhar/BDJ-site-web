  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button 
        ...
        className="flex items-center gap-2 sm:gap-3 bg-white/5 hover:bg-white/10 border border-white/10 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full transition-all group"
      >
