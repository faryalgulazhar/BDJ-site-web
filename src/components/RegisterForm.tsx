      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <div className="relative">
          ...
          <input
            ...
            required
            ref={gamerTagRef}
            className="w-full bg-white/5 border border-white/10 focus:border-primary/50 outline-none rounded-xl pl-12 pr-4 py-4 text-base focus:text-base transition-all duration-500"
          />
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
                className="bg-primary hover:bg-primary/80 disabled:opacity-50 text-white py-4 rounded-xl text-xs font-black tracking-widest uppercase transition-all duration-500 shadow-[var(--shadow-primary)] mt-4 flex items-center justify-center gap-2"
        >
